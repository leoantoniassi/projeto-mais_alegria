...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside 
        className={`fixed left-0 top-0 h-full z-40 w-64 border-r border-outline-variant/30 bg-white flex flex-col transform transition-transform duration-300 ease-in-out ${
