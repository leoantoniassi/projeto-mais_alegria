...
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 2'), (SELECT loc_id FROM locais WHERE loc_nome = 'Local 2'), 5426.00, '2026-03-15', 'rejeitado', 'Obs do orcamento 2'),
...
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 9'), (SELECT loc_id FROM locais WHERE loc_nome = 'Local 9'), 7947.00, '2026-01-15', 'rejeitado', 'Obs do orcamento 9'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 10'), (SELECT loc_id FROM locais WHERE loc_nome = 'Local 10'), 3546.00, '2026-11-15', 'rejeitado', 'Obs do orcamento 10'),
