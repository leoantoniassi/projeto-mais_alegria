...
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 1'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 1'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 1'), 'Evento 1', '2026-05-17 14:00:00', 'confirmado', 150, 110, 35, 5, 'Obs Evento 1'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 2'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 2'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 2'), 'Evento 2', '2026-12-14 14:00:00', 'concluido', 80, 65, 10, 5, 'Obs Evento 2'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 3'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 3'), (SELECT loc_id FROM locais WHERE loc_nome = 'Externo'), 'Evento 3', '2026-01-27 14:00:00', 'confirmado', 120, 90, 25, 5, 'Obs Evento 3'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 4'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 4'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 1'), 'Evento 4', '2026-01-27 14:00:00', 'confirmado', 50, 40, 8, 2, 'Obs Evento 4'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 5'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 5'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 2'), 'Evento 5', '2026-05-06 14:00:00', 'confirmado', 200, 160, 30, 10, 'Obs Evento 5'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 6'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 6'), (SELECT loc_id FROM locais WHERE loc_nome = 'Externo'), 'Evento 6', '2026-07-28 14:00:00', 'confirmado', 95, 75, 15, 5, 'Obs Evento 6'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 7'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 7'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 1'), 'Evento 7', '2026-04-16 14:00:00', 'cancelado', 60, 50, 10, 0, 'Obs Evento 7'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 8'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 8'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 2'), 'Evento 8', '2026-05-17 14:00:00', 'confirmado', 115, 95, 15, 5, 'Obs Evento 8'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 9'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 9'), (SELECT loc_id FROM locais WHERE loc_nome = 'Externo'), 'Evento 9', '2026-10-15 14:00:00', 'confirmado', 130, 100, 25, 5, 'Obs Evento 9'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 10'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 10'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 1'), 'Evento 10', '2026-10-06 14:00:00', 'concluido', 45, 35, 8, 2, 'Obs Evento 10'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 11'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 11'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 2'), 'Evento 11', '2026-03-01 14:00:00', 'pendente', 175, 140, 30, 5, 'Obs Evento 11'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 12'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 12'), (SELECT loc_id FROM locais WHERE loc_nome = 'Externo'), 'Evento 12', '2026-07-16 14:00:00', 'pendente', 70, 60, 8, 2, 'Obs Evento 12'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 13'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 13'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 1'), 'Evento 13', '2026-08-20 14:00:00', 'pendente', 105, 85, 15, 5, 'Obs Evento 13'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 14'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 14'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 2'), 'Evento 14', '2026-12-21 14:00:00', 'cancelado', 90, 70, 18, 2, 'Obs Evento 14'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 15'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 15'), (SELECT loc_id FROM locais WHERE loc_nome = 'Externo'), 'Evento 15', '2026-05-22 14:00:00', 'cancelado', 140, 110, 25, 5, 'Obs Evento 15'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 16'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 16'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 1'), 'Evento 16', '2026-06-01 14:00:00', 'cancelado', 65, 55, 8, 2, 'Obs Evento 16'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 17'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 17'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 2'), 'Evento 17', '2026-09-10 14:00:00', 'cancelado', 85, 70, 12, 3, 'Obs Evento 17'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 18'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 18'), (SELECT loc_id FROM locais WHERE loc_nome = 'Externo'), 'Evento 18', '2026-01-10 14:00:00', 'pendente', 110, 90, 15, 5, 'Obs Evento 18'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 19'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 19'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 1'), 'Evento 19', '2026-10-08 14:00:00', 'pendente', 160, 130, 25, 5, 'Obs Evento 19'),
((SELECT cli_id FROM clientes WHERE cli_nome = 'Cliente 20'), (SELECT orc_id FROM orcamentos WHERE orc_observacoes = 'Obs do orcamento 20'), (SELECT loc_id FROM locais WHERE loc_nome = 'Salão 2'), 'Evento 20', '2026-05-22 14:00:00', 'concluido', 125, 100, 20, 5, 'Obs Evento 20');
