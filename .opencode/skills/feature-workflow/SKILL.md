---
name: dev-workflow
description: Ative para QUALQUER solicitação de alteração, correção, refatoração ou nova funcionalidade no código. Este skill deve ser carregado sempre que houver código a ser escrito, modificado ou corrigido, garantindo o pipeline completo de desenvolvimento, revisão, segurança e testes.
---
